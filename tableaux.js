...
/* for ( value of tab1){
    console.log(value);
}*/ // autre posibilite de connaitre tous les valeurs.
...
maVariable = (tab1.pop());
console.log(maVariable);// mon resultat est 200 et non 58 , pourquio?
...
tab1.push(66);
console.log(tab1); // j'ai une doute !!! c'est bien ?
